...
- Python 3.11 (backend), TypeScript 5 / React 18 (frontend) + FastAPI, SQLAlchemy, pandas_ta_classic, yfinance, cachetools (backend) · React Query, Zustand, Tailwind (frontend) (026-buylist-market-sentiment)
- SQLite/PostgreSQL (기존) — StockMaster.sector 컬럼 추가 마이그레이션 1건 (026-buylist-market-sentiment)
